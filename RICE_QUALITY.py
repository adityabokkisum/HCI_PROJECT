...
#project explanation
text1="""
	Rice is favorable and high consumed cereal grain in Asian countries.
    It can be easily found all over the world. Many value added products are produced by using rice for human beings .
    In the rice market, key determinant of milled rice is quality. The quality measurement becomes more important with
    the import and export trade. Rice samples contain different dispensable objects like paddy, chaff, damaged grains, weed seeds, stones etc.
    Rice quality is varying according to these impurity content.
"""
text2="""
The main purpose of the proposed method is, to offer an alternative way for quality control and analysis which reduce the required effort,
cost and time. Image processing is significant and advanced technological area where important developments have been made.
"""
text3="""
In agricultural and farming production quality control and analysis of manufactured goods is vital.
Quality of grain is analyzed visually by veteran person and technician. But the effect of such measurement is changing in results and prolonged.
The excellence and quality also influenced by the mood and atmosphere of technician; so to overcome the shortcoming occurred due to conventional methods advanced technique i.e.
Image processing technique is projected, to Maintaining the Integrity of the Specifications.
"""
text4="""
Image processing manipulates image for performing some operations on targeted image to get an improved and desirable image.
And extort some valuable information from input image. Nowadays, image processing is hastily growing technologies.
All types of data have to go through three general phases while using digital image processing technique which are pre-processing, enhancement, and display, information extraction.
"""
text5="""
The Agricultural industry on the whole is very vast and ancient. Quality assessment of grains is a very big challenge since time immemorial.
The project presents a solution for quality evaluation and grading of rice grains using image processing techniques.
Commercially the grading of rice is done according to the size of the grain (full, half or broken). The food grains quality are rapidly assessed through visual inspection by human inspectors.
The decision making capabilities of human-inspectors are subjected to external influences such as fatigue, vengeance, bias etc.
With the help of image processing techniques we can overcome that and which are also a non-destructive and cost-effective techniques.
Here we also discuss the procedure used to obtain the percentage quality of rice grains. Rice quality is nothing but the combination of physical and chemical characteristics.
Grain size and shape, chalkiness, whiteness, milling degree, bulk density and moisture content are some physical characteristics, gelatinization temperature and gel consistency are chemical characteristics of rice.
"""
text6="""
Many studies that consider the morphological features of grains such as its area, shape etc. have already been performed.
However, the shapes and sizes of the different varieties are too varied to generalize a common formula for the classification of all varieties of rice.
"""
